...
def setup_logging():
    ...
    try:
        ...
        log.setLevel(logging.INFO)  # Change here to change global logging level
        handler = RotatingFileHandler(filename='rhashira.log', encoding='utf-8', mode='w', maxBytes=max_bytes, backupCount=5)
